...
public class GetChargingPointByIdQuery(IChargingPointRepository chargingPointRepository)
    : IRequestHandler<GetChargingPointByIdRequest, GetChargingPointByIdDto>
{
   ...
   =>await chargingPointRepository.GetChargingPointById(request.Id, cancellationToken);
}