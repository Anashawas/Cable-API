...
public class AddUserCarCommandValidator:  AbstractValidator<AddUserCarCommand>
{
    private readonly IApplicationDbContext _applicationDbContext;
    public AddUserCarCommandValidator(IApplicationDbContext applicationDbContext)
    {
